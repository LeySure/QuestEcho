...
## Downloads
- Main Addon: [QuestEcho‑1.5.0.zip](https://github.com/LeySure/QuestEcho/releases/download/v1.5.0/QuestEcho‑1.5.0.zip)
- Audio Data Packs (pick one matching your game client language):
  - enUS: [QuestEchoData‑enUS.zip](https://github.com/LeySure/QuestEcho/releases/download/v1.5.0/QuestEchoData‑enUS.zip)
  - zhCN: (coming soon)
  - ruRU: (coming soon)
